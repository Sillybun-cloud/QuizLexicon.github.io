...
const quizTipData = [
  ...
  },
  {
    ...
    optionsTip: ['Маркер', 'Правый слэш', 'Тильда'],
    answerTip: 'Маркер',
  },
];
...
const quizArtData = [
  {
    ...
    optionsArt: ['- создание изображений из разноцветных кусочков стекла', '- создание изображений из разноцветных кусочков глины', '- создание объеток из металлической проволоки'],
  ...
  },
  {
    ...
    optionsArt: ['Аксессуары', 'Декорация', 'Бижутерия'],
    answerArt: 'Декорация',
  },
  {
  ...
  },
  {
    ...
    optionsArt: ['Реквизит', 'Бутафория', 'Аксессуары', 'Декорации'],
    answerArt: 'Бутафория',
  },
  {
